		...
		help.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				String rules = 
						...
						"</p>" +
						"<p>" +
							"On commence par donner à chacun une carte qui reste cachée, face contre la table. Cette étape est répétée de façon à ce que chaque joueur dispose de 3 cartes devant lui, dont on ignore la valeur et la couleur. Ensuite, chaque joueur reçoit 3 cartes supplémentaires, toujours distribuées une à une, mais cette fois-ci, la couleur et la valeur de chaque carte sont montrées à tous. Enfin, on termine en donnant à tous les participants 3 autres cartes qui seront tenues en main et donc cachées des adversaires. Le reste des cartes constitue la pioche." +
							"Chaque joueur dispose ainsi de 9 cartes : <b>3 faces cachées, 3 faces visibles et 3 en main</b>." +
						"</p>" +
						"<p>" +
							"Avant de commencer la partie, les participants peuvent échanger les cartes qu'ils ont en main avec leurs cartes visibles. Il n'y a qu'à ce point du jeu que l'on peut changer ses cartes. Par expérience, on remarque qu'il est préférable de disposer devant soi des cartes qui ont une forte valeur ou des cartes spéciales (celles-ci seront détaillées plus loin)." +
						"</p>" +
						"<p>" +
							"Au début de la partie, le joueur peut choisir de poser une, deux, trois ou quatre cartes sur la table, du moment que celles-ci sont de même valeur (la couleur n'importe pas). En outre, aussi longtemps qu'il reste des cartes dans la pioche, un joueur doit toujours posséder 3 cartes en main. Ainsi, après avoir déposé ses cartes, le joueur reprend dans la pioche le nombre nécessaire de cartes afin de compléter sa main." +
							...
							"Toutefois, il arrivera rapidement un moment où l'un des joueurs n'aura plus la possibilité de poser de cartes suffisamment grosses. Dans ce cas, celui-ci <b>ramasse le paquet constitué</b> et dispose désormais de toutes celles-ci pour jouer ( se dit aussi \"qu'il cocogne\"). La main passe au joueur suivant." +
						"</p>" +
						"<p>" +
							"Lorsque la pioche sera épuisée, chaque joueur devra vider sa main afin de pouvoir ramasser les 3 cartes visibles devant lui. Dès qu'un des joueurs n'a plus de cartes en main, il les ramasse simplement et continue à jouer comme précédemment." +
							"Lorsqu'un joueur n'a de nouveau plus de cartes en main, il pioche une des trois cartes retournées disposées devant lui. Si celle-ci convient, il la pose et peut en prendre une autre qu'il posera à son tour si elle convient. S'il ne peut jouer cette carte, le joueur ramasse le tas et doit éliminer les cartes qu'il a en main avant de pouvoir à nouveau ramasser une des cartes devant lui." +
						"</p>" +
						"<p>" +
						...
						"<p>" +
							...
							"<ul>" +
								...
								"<li>7 : Le joueur suivant doit impérativement jouer une (ou plusieurs) cartes de valeur inférieure ou égale à 7 (quel que soit le nombre de 7 posés).</li>" +
								"<li>8 : Le joueur suivant passe son tour (si on met plusieurs 8, autant de joueurs que de 8 posés passent leur tour).</li>" +
								"<li>10 : Les cartes du tas (le 10 compris) sont retirées du jeu (se dit aussi, qu'il bêche). Elles ne pourront pas revenir dans la partie.</li>" +
								"<li>As : Cette carte permet d'attaquer le joueur que l'on veut. Le tour passe au joueur attaqué. Si ce joueur ne peut pas répondre à l'attaque, il prend le tas et finit son tour. Cette carte ne peut être répondue que par un autre As ou un 3 (provoquant une nouvelle attaque), un 2 (annulant l'effet de l'attaque), ou un 10 (coupant le jeu).</li>" +
							"</ul>" +
							"Lorsque l'on a 4 cartes de valeurs identiques qui se suivent (par exemple 4 Rois, 4 Six, 4 Sept, ...), on obtient le même effet qu'en posant un Dix (ça bêche) : le tas est retiré du jeu, permet de raccourcir un peu la partie. Quand un joueur bêche (par un 10 comme par un quadruple), il rejoue directement. Les 3 copiants d'autre cartes ne coupent pas le tas (quatre 3 qui se suivent le feront cependant)." +
						"</p></html>";
